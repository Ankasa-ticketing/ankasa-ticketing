      ...
      <Row className="mx-5 mt-5 mb-5">
        <Col lg={12}>
          <Row className="mb-5 mt-5 mx-auto title">
            ...
            <Col md={6} className="d-flex justify-content-end title">
              <p className="fs-5 fw-semibold text-primary">View All</p>
            </Col>
          </Row>
        </Col>
        ...
        <Col lg={7} className="d-flex justify-content-end trend">
          ...
          >
            ...
            <Card.Body>
              <Card.Subtitle className="mb-2 ">Tokyo,</Card.Subtitle>
              <Card.Title>
                <Row>
                  <Col md={6}>
                    <h3>Japan</h3>
                  ...
                  <Col md={6} className="d-flex justify-content-end">
                    <img src={more} alt="" className="h-75 mt-1" />
                  </Col>
                </Row>
                <div className="label-top shadow-sm">22 Airlines</div>
              </Card.Title>
            </Card.Body>
          </Card>
          <Card
