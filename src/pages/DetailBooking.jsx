            ...
            >
              ...
              <Row className={styles.border_ticket}>
                <Col
                  md={7}
                  className="p-5"
                  style={{ borderRight: "3px dotted #E5E5E5" }}
                >
                  <Row className=" mb-5 w-100">
                    ...
                    <Col md={2} className="d-flex align-items-center">
                      <img src={pesawat} alt="" className="mx-2" />
                    </Col>
                    <Col md={2} className="d-flex align-items-center">
                  ...
                  <Row>
                    <Col
                      md={6}
                      style={{ fontFamily: "Lato", color: "#A5A5A5" }}
                    >
                ...
                <Col md={5} className="p-5 d-flex align-items-center">
